    ...
    <div class="box col-md-4">
        <div class="box-inner">
            ...
            <div class="box-content">
              ...
              <div id="chartContainer5h" style="height: 265px; width: 89%;size: 300px;font-size: 130px; color: #69a1ea; ">
     ...
     <div class="box col-md-4">
        <div class="box-inner"  style="height: 356px;">
            <div class="box-header well" data-original-title="">
                <h2><i class="mdi mdi-arrow-down-bold-circle"></i> Draft cooler with Lowest Quantity In Stock</h2>
            ...
            <div class="box-content">
              <table >
                <tr ><th style="width: 200px;">
                  ...
                  <th style="width: 200px;"><h3 style="color: orange;margin-bottom: 10px; text-align: center;"></h3></th>
                  <th style="width: 300px;" >
                    <h3 style="color: red;margin-bottom: 10px;text-align: center;">Quantity</h3>
                  </th>
                </tr>
                <tr><td rowspan="2">
              <a href='docnotif.php?ID=0' style=' color: orange;text-decoration: none;height: 200px; text-align: center; size: 300px;font-size: 60px; color: orange;margin-left: 20px;'><?php echo "Test"; ?></a>
                 </td>
                <td></td>
                 <td>
            <a href='docnotif2.php?ID=0' style=' color: red;text-decoration: none;height: 200px; text-align: center; size: 300px;font-size: 160px;margin-left: 20px;'><?php echo $result81row; ?></a>
                 </td>
               </tr>
              </table>
            </div>
...
<br><br>
                <div class="d-flex no-block align-items-center">
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped bg-info" role="progressbar" style="width: 70%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <br><br>
                <div class="d-flex no-block align-items-center">
...
<div class="row">
    ...
    <div class="box col-md-6">
        <div class="box-inner">
            <div class="box-header well" data-original-title="" style="background: linear-gradient(to right, black 70%,#fa284b);">
                <h2 style="color:white;"><i class="glyphicon glyphicon-star-empty"></i> Created Document Per Week</h2>
      ...
      <div class="box col-md-6">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-star-empty"></i> NUMBER OF DOCUMENTS WITH THEIR EXPIRY DATE</h2>
...
{ ?>
  ...
  <tr>
    ...
    echo $results[0]->Agenda; 
     ?><?php }else if ($result->Revision != '' || $result->Revision !=NULL || $result->Revision != 0) { echo $result->Document_Name.' '.$result->Revision;}else if ($result->Version != '' || $result->Version != NULL || $result->Version != '0') { echo $result->Document_Name.' '.$result->Version;}else { echo $result->Document_Name; } ?></td>
