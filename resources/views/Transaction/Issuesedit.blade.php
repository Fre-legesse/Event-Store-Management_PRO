                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            @foreach($category as  $type2) 
                                             ...
                                             <?php $val=$type2->Approval1Quantity ?>
                                          ...
                                          @if($val != null || $val > 0)
                                            ...
                                            @else
                                             ...
                                             <input type="number" class="form-control" id="email1" name="Quantity[{{ $type->Item }}][]"   placeholder="Quantity" disabled>
                                            @endif
                                         ...
                                         <div class="col-sm-4">
                                            ...
                                            <select class="select2 form-control custom-select" style="width: 40%; height:36px;" name='Issued[{{ $type->Item }}][]' >
                                                <option value="">Select</option>
                                        <option value="Issued" {{'Issued' == $Issue   ? 'selected' : ''}} >Issued</option>
                                          </select>
                                          @else
