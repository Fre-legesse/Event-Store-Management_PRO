...
@endif
                    <form method="post" action="/Color" class="form-horizontal" >
                                ...
                                <div class="card-body" style="background-color: ">
                                    ...
                                    <div class="col-md-9">
                                        <select class="select2 form-control custom-select demo" id="position-bottom-left" data-position="top right" style="width: 100%; height:36px;" name='Color'>
                                            ...
                                            <option value="RED">Red</option>
                                                ...
                                                <option value="VANELA">Vanela</option>
