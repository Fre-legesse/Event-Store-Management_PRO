...
try{
    ...
    $link = new \PDO(   'mysql:host=10.10.1.79;dbname=cv_application;charset=utf8mb4', //'mysql:host=localhost;dbname=canvasjs_db;charset=utf8mb4',
                        'Jobs', //'root',
                        'Pass$$100', //'',
                        array(
        ...
        <style type="text/css">
           .dd {
               ...
               background-color: #e0ebeb;
                background-image: url('../../assets/images/bgibgi.png')   !important;
