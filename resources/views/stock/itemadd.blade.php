    ...
    <meta name="csrf-token" content="{{ csrf_token() }}" />
                    ...
                    <form method="post" action="/Item" class="form-horizontal" >
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-9">
                                        <select   class="select2 form-control custom-select" style="width: 75%; height:36px;" name='Type' id="Type">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                            <select name="Fabric" id="Fabric" class="select2 form-control custom-select" style="width: 75%; height:36px;">
                            <option value="">Please Select Item Type</option> 
                                    ...
                                    <div class="col-md-9">
                            <select name="Color" id="Color" class="select2 form-control custom-select" style="width: 75%; height:36px;">
                            <option value="">Please Select Item Type</option> 
                            </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                            <select name="Brand" id="Brand" class="select2 form-control custom-select" style="width: 75%; height:36px;">
                            <option value="">Please Select Item Type</option> 
                            </select>
                                    </div>
                                </div>
                    ...
                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Manufacturer</label>
                                    ...
                                    <div class="col-md-9">
                            <select name="Manufacturer" id="Manufacturer" class="select2 form-control custom-select" style="width: 75%; height:36px;">
                            <option value="">Please Select Item Type</option> 
                            </select>
                                    </div>
                                </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" name="Size" placeholder="example: Big, small, Double Door" max="10" style="width: 145px;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="Status" id="Status" class="select2 form-control custom-select" style="width: 75%; height:36px;">
                            ...
                            <option value="Non_Returnable">Non Returnable</option> 
                                     ...
                                     <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Countable/Uncountable</label>
                                        <div class="col-sm-9">
                                             <select name="Countable" id="Countable" class="select2 form-control custom-select" style="width: 75%; height:36px;">
                            <option value="">Please Select Status</option>
