...
<!--          <a href="docAdd.php"><i class="glyphicon glyphicon-plus"></i><span>New</span></a> -->
  ...
  <tr>
            ...
            <td  style='text-align: center;'><div class="bs-example"><div id="myPopovers"> 
 
<a href="#" data-toggle="popover" data-trigger="focus" data-html="true" data-placement="top"  data-content=" 
<table class='table'>
                  <thead>
          <tr>
...
@endphp
 ...
 <div class="row">
            ...
            <a style="white-space: nowrap;"  type="button" href="/Event/{{ $item->EVID }}/itemadd" class="btn btn-warning btn-sm"><i class="mdi mdi-library-plus"></i></a>  

            <a style="white-space: nowrap;"  type="button" href="/Event/{{ $item->EVID }}/edit" class="btn btn-default btn-sm">Edit</a>
