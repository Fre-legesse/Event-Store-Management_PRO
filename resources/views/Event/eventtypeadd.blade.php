...
@endif
                    <form method="post" action="/Eventtype" class="form-horizontal" >
                            	@csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" name="Type_Name" placeholder="example: Wedding, Graduation">
                                        </div>
                                    </div>
