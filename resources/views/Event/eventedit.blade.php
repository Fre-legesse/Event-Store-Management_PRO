                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" class="form-control" id="email1" name="Date_From" placeholder="" value="{{   $newDate = date("m/d/Y", strtotime($RealEvent->Date_From)) }}" disabled>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="email1" name="Date_To" placeholder="" value="{{   $newDate = date("m/d/Y", strtotime($RealEvent->Date_To)) }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Location</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="email1" name="Location" placeholder="" value="{{ $RealEvent->Location }}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Description</label>
                                        <div class="col-sm-9">
                                            <textarea  class="form-control" id="email1" name="Event_Name" placeholder="" value="{{ $RealEvent->Description }}" disabled cols="5" rows="5">{{ $RealEvent->Description }}</textarea> 
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Event Type</label>
                                    <div class="col-md-9">
                                             <select class="select2 form-control custom-select" style="width: 40%; height:36px;" name='Event_Type' disabled>
  ...
  <div class="col-md-6">
                              <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="col-md-9">
                                         <input type="text" class="form-control" id="email1" name="Requester" style="width: 450px;" value="{{ $ItemRequest->Requester }}" disabled>
                                    ...
                                    <div class="col-md-9">
                                             <input type="text" class="form-control" id="email1" name="Responsible_Person" style="width: 450px;" value="{{ $ItemRequest->Responsible_person }}" disabled>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                             <input type="text" class="form-control" id="email1" name="Phone_Number" style="width: 450px;" value="{{ $ItemRequest->Phone_Number }}" disabled>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="email1" name="Return_date" style="width: 450px;" disabled >
                                        </div>
                                    </div>
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            @foreach($category as  $type2) 
                                             ...
                                             @if($ItemRequest->ApprovalOne == 'Approve' and $ItemRequest->ApprovalTwo == 'Not Approve')
                                             @php $val=$type2->Approval1Quantity @endphp
                                             @elseif($ItemRequest->ApprovalTwo == 'Approve')
                                          ...
                                          @if($val != null || $val > 0)
                                            ...
                                            <?php $val=0; ?>
                                            @else
                                             <input type="number" class="form-control" id="email1" name="Quantity[{{ $type->Item }}][]"   placeholder="Quantity">
                                            @endif

                                            
                                        </div>
                                         <div class="col-sm-4">
                                            <input type="number" class="form-control" id="email1"  placeholder="Quantity in Stock : {{ $type->Quantity }}" disabled>
