...
<div class="card-body">
                                    ...
                                    <a class="btn btn-lg btn-default" href="Category/create/">Add New</a>
...
<!--          <a href="docAdd.php"><i class="glyphicon glyphicon-plus"></i><span>New</span></a> -->
 ...
 <div class="row">
            ...
            <a style="white-space: nowrap;"  type="button" href="Category/{{ $item->STID }}/edit" class="btn btn-default btn-sm">Edit</a>

           <form method="POST" action="/Category/{{ $item->STID }}">
           {{ csrf_field() }}
  {{ method_field('DELETE') }}
