...
@endif
    ...
    <select class="select2 form-control custom-select" style="width: 100%; height:36px;" name='Department'>
                            ...
                            <option value="General Management" {{'General Management' == $Item->Department  ? 'selected' : ''}}>General Management</option>
                                                <option value="Administration" {{'Administration' == $Item->Department  ? 'selected' : ''}}>Administration</option>
                                                <option value="Finance" {{'Finance' == $Item->Department  ? 'selected' : ''}}>Finance</option>
                                                <option value="Supply Chain" {{'Supply Chain' == $Item->Department  ? 'selected' : ''}}>Supply Chain</option>
                                                <option value="Production and continuous improvement" {{'Production and continuous improvement' == $Item->Department  ? 'selected' : ''}}>Production and continuous improvement</option>
                                                <option value="Quality Control" {{'Quality Control' == $Item->Department  ? 'selected' : ''}}>Quality Control</option>
                                                <option value="Sales" {{'Sales' == $Item->Department  ? 'selected' : ''}}>Sales</option>
                                                <option value="Marketing" {{'General Management' == $Item->Department  ? 'selected' : ''}}>Marketing</option>
