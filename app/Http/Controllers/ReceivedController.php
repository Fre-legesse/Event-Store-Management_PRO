...
class ReceivedController extends Controller
{
    ...
    public function index()
    {
        ...
        $item = DB::table('item_requests')->join('events', 'item_requests.Event_id', '=', 'events.EVID')->where(['item_requests.Company' => $loc, 'item_requests.Department' => $dep, 'ApprovalOne' => 'Approved', 'ApprovalTwo' => 'Approved', 'Issued' => 'Issued'])->select('*')->get();
        //dd($item);
        //$list=Stock::distinct()
        //dd($requested_list);
